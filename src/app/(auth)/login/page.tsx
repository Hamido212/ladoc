    ...
    <div className="w-full max-w-sm">
      ...
      <div className="mt-4 flex gap-3">
        <button
          ...
          className="flex-1 py-2.5 border border-gray-200 rounded-xl font-medium hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 text-sm"
        >
